...
counterparty-client-id = "07-tendermint-1"
...
counterparty-client-id = "07-tendermint-3"

[[chains.clients]]
client-id = "07-tendermint-4"
counterparty-chain-id = "counterparty-chain-3"
counterparty-client-id = "07-tendermint-5"
`
	...
	assert.Equal(t, "07-tendermint-1", config.Chains[0].Clients[0].CounterpartyClientID)
	...
	assert.Equal(t, "07-tendermint-3", config.Chains[1].Clients[0].CounterpartyClientID)
	...
	assert.Equal(t, "07-tendermint-5", config.Chains[1].Clients[1].CounterpartyClientID)
}
